...
class Arm64ToSimTestCase: XCTestCase {
    ...
    private func testConvert(deviceTarget: String, simulatorTarget:String, file: StaticString = #file, line: UInt = #line) {
        ...
        Transmogrifier.processBinary(atPath: tempDir.appendingPathComponent("return2.ios.device.o").path, minos: 13, sdk: 13, platform: Platform.IOSSIMULATOR, isDynamic: false)
